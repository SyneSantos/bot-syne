...
const config = {
    A187: 'Synezinho',
    instagram: 'OFF',
    nomer: 'wa.me/21967609575',
    aktif: '24 JAM',
    youtube: 'https://youtube.com/channel/UCcEMMBzUS2pwkzduGU-Xbwg',
    whatsapp: 'https://chat.whatsapp.com/DcbaCw3Wmi3KYJCiWPWevS',
   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'escrever':
           escrever(value)
               .then(data => {
                   client.sendMessage(id, '[Pera ae...', MessageType.text)
       ...
       case 'Letramusica':
           Letramusica(value)
               .then(data => {
                   const { hasil: Letramusica } = data
                   let hasil = `Letramusica *${value}* \n\n\n${Letramusica}`
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
 ...
 case 'infogempa':
   ...
   case 'acorde':
           acorde(value)
               .then(data => {
                   const { result } = data
                   let hasil = `Aqui estão os acordes da música *${value}* pedida️\n\n  _${result}_ `
                   client.sendMessage(id, hasil, MessageType.text)
               })
               .catch(err => {
                   console.log(err)
  ...
  case 'cektanggal':
   ...
   case 'bitly':
    ...
    case 'gado':
           ...
           map()
               .then(buffer => {
                   client.sendMessage(id, '[Pera krl...', MessageType.text)
                   client.sendMessage(id, buffer, MessageType.image)
               })
               .catch(err => {
                   console.log(err)
           ...
           waifu()
               .then(buffer => {
                   client.sendMessage(id, '[Calma o cu...', MessageType.text)
                   client.sendMessage(id, buffer, MessageType.image)
               })
               .catch(err => {
                   console.log(err)
      ...
      case 'loli':
           loli()
               .then(buffer => {
                   client.sendMessage(id, '[Relaxa ae...', MessageType.text)
                   client.sendMessage(id, buffer, MessageType.image)
               })
               .catch(err => {
                   console.log(err)
     ...
     case 'cooltext':
           ...
           nekonime()
               .then(buffer => {
                   client.sendMessage(id, '[Calma punheteiro...', MessageType.text)
                   client.sendMessage(id, buffer, MessageType.image)
               })
               .catch(err => {
                   console.log(err)
